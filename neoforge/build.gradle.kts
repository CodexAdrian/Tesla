...
dependencies {
    ...
    jarJar(implementation(group = "earth.terrarium.common_storage_lib", name = "common-storage-lib-lookup-neoforge-$minecraft_version", version = csl_version)) {
        isTransitive = false
    }

    jarJar(implementation(group = "earth.terrarium.common_storage_lib", name = "common-storage-lib-data-neoforge-$minecraft_version", version = csl_version)) {
        isTransitive = false
    }
}
